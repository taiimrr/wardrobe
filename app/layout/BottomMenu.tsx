...
const BottomMenu = ({ state, navigation, descriptors }: Props) => {
  ...
  const tabWD = tabWidth < SIZES.container ? tabWidth / 7 : SIZES.container / 7;
  ...
  const onTabPress = (index: any) => {
    const tabW =
      tabWidth < SIZES.container ? tabWidth / 7 : SIZES.container / 7; // Adjust this according to your tab width
